...
try:
    myappid = 'group5.hospital.management.1.0'
...
class HospitalApp:
    ...
    def __init__(self, root):
        ...
        self.root = root
        self.root.title("Group 5 - Hospital Management System")
    ...
    def setup_sidebar_buttons(self):
        ...
        """
        tk.Label(self.sidebar, text="🏥 Group 5 HMS", bg=self.sidebar_color, fg="white", font=("Segoe UI", 16, "bold")).pack(pady=20)
        menu = [
